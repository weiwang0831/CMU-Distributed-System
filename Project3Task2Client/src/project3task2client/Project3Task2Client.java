...
public class Project3Task2Client {
        ...
        while (userInput != 4) {
            ...
            switch (userInput) {
                ...
                case 1:
                    ...
                    if (result.equals("success! to execute")) {
                ...
                case 2:
                    ...
                    XMLString = "<data>"
                            + "<option>2</option>"
                            + "</data>";
                    System.out.println("Chain verification:" + parseXML(XMLString));
                ...
                case 3:
                    ...
                    XMLString = "<data>"
                            + "<option>3</option>"
                            + "</data>";
                    System.out.println(parseXML(XMLString));
                    break;
                case 4:
                    break;
            }
    ...
    private static String parseXML(java.lang.String xmlString) {
        ...
        return port.parseXML(xmlString);
    }
